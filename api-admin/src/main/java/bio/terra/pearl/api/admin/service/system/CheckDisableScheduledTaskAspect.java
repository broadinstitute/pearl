...
@Aspect
@Component
public class CheckDisableScheduledTaskAspect {
  private final SystemSettingsService maintenanceModeService;

  public CheckDisableScheduledTaskAspect(SystemSettingsService maintenanceModeService) {
  ...
  @Around("@annotation(bio.terra.pearl.api.admin.service.system.CheckDisableScheduledTask)")
  public Object checkTasksDisabled(ProceedingJoinPoint joinPoint) throws Throwable {
