...
import { MaintenanceModeSettings } from './maintenance/MaintenanceSettings'
import Api from './api/api'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faScrewdriverWrench } from '@fortawesome/free-solid-svg-icons'
import { Markdown } from '@juniper/ui-core'

export function MaintenanceMode2({ children }: { children: React.ReactNode }) {
